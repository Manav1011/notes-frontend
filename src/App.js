...
function App() {
  ...
  return (
    <BrowserRouter>
        <Helmet>
                <style>{darkMode? `body { background: #0f0c29;background: -webkit-linear-gradient(to right, #24243e, #302b63, #0f0c29);background: linear-gradient(to right, #24243e, #302b63, #0f0c29);}`:`body { background: #757F9A;  /* fallback for old browsers */
